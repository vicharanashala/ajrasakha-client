          ...
          <>
            ...
            {showAgentMarketplace && (
              <div
                ...
                className="group relative flex w-full cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-sm text-text-primary hover:bg-gray-300 dark:hover:bg-gray-800"
