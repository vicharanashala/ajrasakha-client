...
function AccountSettings({ collapsed = false }: { collapsed?: boolean }) {
  ...
  const selectTrigger = (
    <Select.Select
      ...
      className={
        collapsed
          ? 'flex h-10 w-10 cursor-pointer items-center justify-center rounded-xl p-0 transition-all duration-200 ease-in-out aria-[expanded=true]:bg-gray-300 dark:aria-[expanded=true]:bg-gray-800'
          : 'mt-text-sm flex h-auto w-full cursor-pointer items-center gap-2 rounded-xl p-2 text-sm transition-all duration-200 ease-in-out aria-[expanded=true]:bg-gray-300 dark:aria-[expanded=true]:bg-gray-800'
      }
    >
