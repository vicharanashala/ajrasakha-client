  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Brand green — exactly two approved shades (Light for light-mode surfaces,
        // Dark for dark-mode surfaces). Every numeric key collapses to one of the two so
        // any existing `bg-green-*`/`text-green-*`/etc. class in the app renders one of
        // only these colors, never an in-between shade.
        green: {
          50: '#75D7B2',
          100: '#75D7B2',
          200: '#75D7B2',
        ...
        // Tailwind's stock `emerald` scale isn't otherwise overridden in this project, but
        // several components use emerald-* classes for the same brand green — collapse it
        // to the same two shades so it can't reintroduce a third green.
        emerald: {
          50: '#75D7B2',
          100: '#75D7B2',
          200: '#75D7B2',
